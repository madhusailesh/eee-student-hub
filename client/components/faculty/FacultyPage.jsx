...
export default function FacultyPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-100/60 text-slate-900 px-4 py-6 md:px-8 md:py-10 transition-colors duration-300 dark:bg-slate-950 dark:text-slate-100 selection:bg-amber-500 selection:text-white">
