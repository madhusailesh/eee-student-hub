      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
        ...
        <div className="space-y-5 border-b border-slate-200 pb-6 dark:border-slate-800">
          <div className="flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-500 dark:text-slate-400">
            <Link href="/semester" className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">
              Semesters
            </Link>
            <span>/</span>
            <Link href={`/semester/${semester}`} className="hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors">
              Semester {semester}
            </Link>
            <span>/</span>
