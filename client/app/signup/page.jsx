...
export default function SignupPage() {
  return (
    <main className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center bg-slate-50/60 px-4 py-12 transition-colors duration-300 dark:bg-slate-950 dark:text-slate-100 selection:bg-cyan-500 selection:text-white overflow-hidden">
      ...
      <div className="fixed -top-32 -left-32 h-96 w-96 rounded-full bg-cyan-500/10 blur-[90px] pointer-events-none transform-gpu" />
      <div className="fixed -bottom-32 -right-32 h-96 w-96 rounded-full bg-indigo-500/10 blur-[90px] pointer-events-none transform-gpu" />
